...
function buildSudokuTable(){
    ...
    for(i = 0; i <= 80; i++){
        ...
        htmlText += '<textarea id="'+i+'" maxlength="1" class="cell_text_area"></textarea>';
        htmlText += '</div>';
    ...
    for(let i = 0; i <= cell.length - 1; i++){
        ...
        cell[i].addEventListener("keydown", function(e){
            ...
            if(isNumberExist(cell[i].id, e.key)){
                alert("DOUBLON");
                e.preventDefault();
            }
        });
...
function getSudokuNumbers(){
    ...
    let cells = document.getElementsByClassName("cell_text_area");
...
function isNumberExist(id, key){

    let cellsTable = getSudokuNumbers();
    let cells = document.getElementsByClassName("cell_text_area");
    ...
    // Check X Axis
    for(let i = 0; i <= 8; i++){
        if(cells[cellsTable[x][i]].value == key){
            return true;
        }
    }
    ...
    // Check Y Axis
    for(let i = 0; i <= 8; i++){
        if(cells[cellsTable[i][y]].value == key){
            return true;
        }
    }
    ...
    if(sectionA0.includes(parseInt(id))){        
        for(let i = 0; i <= 8; i++){
            if(cells[sectionA0[i]].value == key){
                return true;
            }
        }
    }else if(sectionA1.includes(id)){
        for(let i = 0; i <= 8; i++){
            if(cells[sectionA1[i]].value == key){
                return true;
            }
        }
    }else if(sectionA2.includes(id)){
        for(let i = 0; i <= 8; i++){
            if(cells[sectionA2[i]].value == key){
                return true;
            }
        }
    }else if(sectionB0.includes(id)){
        for(let i = 0; i <= 8; i++){
            if(cells[sectionB0[i]].value == key){
                return true;
            }
        }
    }else if(sectionB1.includes(id)){
        for(let i = 0; i <= 8; i++){
            if(cells[sectionB1[i]].value == key){
                return true;
            }
        }
    }else if(sectionB2.includes(id)){
        for(let i = 0; i <= 8; i++){
            if(cells[sectionB2[i]].value == key){
                return true;
            }
        }
    }else if(sectionC0.includes(id)){
        for(let i = 0; i <= 8; i++){
            if(cells[sectionC0[i]].value == key){
                return true;
            }
        }
    }else if(sectionC1.includes(id)){
        for(let i = 0; i <= 8; i++){
            if(cells[sectionC1[i]].value == key){
                return true;
            }
        }
    }else if(sectionC2.includes(id)){
        for(let i = 0; i <= 8; i++){
            if(cells[sectionC2[i]].value == key){
                return true;
            }
        }
    }
